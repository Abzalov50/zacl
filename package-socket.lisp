...
(defun socket:make-socket (&key connect local-port local-host
			     reuse-address remote-port remote-host
...
(defun socket::make-ssl-server-stream (socket
					 ...
					 certificate-password
                                         verify
                                         ca-file ca-directory crl-file
					 crl-check method max-depth)
  (declare (ignore max-depth method crl-check crl-file ca-directory
		   ca-file verify))
